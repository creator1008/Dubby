...
| **3.0** | (main) | Gemini 3.7 Flash full-document STT + spoken translation + timestamps/speakers, ElevenLabs v3 TTS. `3.0.6` sends Voice Clone media to R2 (Caddy 10MB / Cloudflare origin caps no longer block 100MB+ files). |
