...
| **3.0** | (main) | Gemini 3.7 Flash full-document STT + spoken translation + timestamps/speakers, ElevenLabs v3 TTS. `3.0.1` removes Vertex-only `audioTimestamp` (AI Studio keys return 400). |
