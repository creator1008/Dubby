...
| **3.0** | (main) | Gemini 3.7 Flash full-document STT + spoken translation + timestamps/speakers, ElevenLabs v3 TTS. `3.0.9` fetches TikTok via item-detail (crawler UA) instead of yt-dlp webpage WAF. |
