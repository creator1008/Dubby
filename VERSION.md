...
| **3.0** | (main) | Gemini 3.7 Flash full-document STT + spoken translation + timestamps/speakers, ElevenLabs v3 TTS. `3.0.8` fetches TikTok without curl_cffi impersonation (webpage challenge HTML). |
