...
const MESSAGE_LABELS_KO: Record<string, string> = {
  ...
  voice_changer: "Voice Changer 적용",
...
const MESSAGE_LABELS: Record<Locale, Record<string, string>> = {
  ...
  en: {
    ...
    voice_changer: "Applying Voice Changer",
    ...
    prepare_segments: "Saving subtitle segments",
  ...
  vi: {
    ...
    voice_changer: "Áp dụng Voice Changer",
    ...
    prepare_segments: "Lưu các đoạn phụ đề",
